...
use rune::runtime::{
    AnyObj, FromValue, Object, Shared, Struct, SyncFunction, ToValue, Value, VmError,
};

use crate::{function::DebugSyncFunction, http::Client, regex::Regex, uuid::Uuid};
...
impl FromValue for SendValueKind {
    fn from_value(value: rune::runtime::Value) -> Result<Self, rune::runtime::VmError> {
        let value = match value {
            ...
            Value::Object(v) => Self::Object(Self::convert_object_to_map(v.take()?.iter())?),
...
impl ToValue for SendValueKind {
    fn to_value(self) -> Result<Value, rune::runtime::VmError> {
        let value = match self {
            ...
            Self::Object(v) => Value::Object(Shared::new(Self::convert_map_to_object(v)?)),
...
impl SendValueKind {
    fn from_struct(mut data: Struct) -> Result<Self, rune::runtime::VmError> {
        ...
        *data.get_mut("from_rust").unwrap() = ToValue::to_value(None::<String>).unwrap();
    ...
    pub fn convert_map_to_object(value: HashMap<String, SendValue>) -> Result<Object, VmError> {
